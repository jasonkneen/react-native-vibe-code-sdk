---
title: "@react-native-vibe-code/integrations"
description: A comprehensive package for managing AI and external service integrations in React Native Vibe Code
---
