 ...
 */
export function connectSandbox(sandboxId: string, opts?: { enforceMaxLifetime?: false }): Promise<Sandbox>
export function connectSandbox(sandboxId: string, opts: { enforceMaxLifetime?: boolean }): Promise<Sandbox | null>
