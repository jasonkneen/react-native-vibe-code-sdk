...
Visual element selection and editing for React Native Vibe Code. Enables users to visually select elements in the React Native/Expo preview and have those selections sent to the chat interface for AI-powered editing.
