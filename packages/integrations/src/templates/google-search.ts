export const googleSearchTemplate = (prodUrl: string, displayName: string, description: string) => `---
name: ${displayName}
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, backgroundColor: '#f1f3f4', borderRadius: 24, padding: 12, paddingHorizontal: 20, fontSize: 16 },
  searchButton: { backgroundColor: '#4285f4', paddingHorizontal: 24, borderRadius: 24, justifyContent: 'center' },
  searchButtonText: { color: 'white', fontWeight: '600', fontSize: 16 },
  searchInfo: { fontSize: 13, color: '#70757a', marginBottom: 12 },
  loader: { marginVertical: 20 },
  error: { color: '#d93025', textAlign: 'center', marginBottom: 16 },
  resultCard: { marginBottom: 20 },
  displayedLink: { fontSize: 12, color: '#202124', marginBottom: 4 },
  resultTitle: { fontSize: 20, color: '#1a0dab', marginBottom: 4, fontWeight: '400' },
  resultSnippet: { fontSize: 14, color: '#4d5156', lineHeight: 20 },
  emptyText: { textAlign: 'center', color: '#70757a', marginTop: 40, fontSize: 16 },
});
\`\`\`
