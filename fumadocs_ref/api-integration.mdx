...
**Example Usage:**
```typescript
const response = await fetch('https://capsulethis.com/api/toolkit/llm', {
  method: 'POST',
  headers: {
...
const response = await fetch('https://capsulethis.com/api/toolkit/stt', {
  method: 'POST',
  body: formData
});
...
**Example Usage:**
```typescript
const response = await fetch('https://capsulethis.com/api/toolkit/search', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
...
**Example Usage:**
```typescript
const response = await fetch('https://capsulethis.com/api/toolkit/exa-search', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
...
**Example Usage:**
```typescript
const response = await fetch('https://capsulethis.com/api/toolkit/images', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
