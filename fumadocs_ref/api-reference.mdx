...
- **Production:** `https://capsulethis.com`
...
```typescript
// Chat API
const response = await fetch('https://capsulethis.com/api/chat', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
function ChatScreen({ projectId, userId }) {
  const { messages, input, handleInputChange, handleSubmit } = useChat({
    api: 'https://capsulethis.com/api/chat',
...
```bash
# Create project
curl -X POST https://capsulethis.com/api/projects \
...
# Transcribe audio
curl -X POST https://capsulethis.com/api/toolkit/stt \
  -F "audio=@recording.wav" \
  -F "language=en"

# Generate image
curl -X POST https://capsulethis.com/api/toolkit/images \
  -H "Content-Type: application/json" \
  -d '{
...
- **Documentation:** https://docs.capsulethis.com
- **API Status:** https://status.capsulethis.com
